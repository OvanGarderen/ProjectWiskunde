...
Wanneer $g \in L_1(\R)$, dan geldt \cite{fourier-fout}
\eq{
...
TODO: discreet $\to$ continu voor grote dataset, verder nog een definitie van smooth geven op discrete functies
