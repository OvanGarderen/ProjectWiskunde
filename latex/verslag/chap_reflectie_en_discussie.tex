...
Het gele mannetje verdwijnt in de Mallatdecompositie na ongeveer 5 tijdseenheden terwijl deze bij 
de mengvorm na 8 frames nog steeds zichtbaar is.

\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{frames_nontensor.png}
\caption{croppedgif.gif, frames 71 t/m 77 met 2\% compressie door de Daubechies 2 wavelet in de Mallatdecompositie}
\label{fig:frames_tensor}
\end{figure}

\begin{figure}[h]
\centering
\includegraphics[width=\linewidth]{frames_tensor.png}
\caption{croppedgif.gif, frames 71 t/m 77 met 2\% compressie door de Daubechies 2 wavelet in de mengvorm}
