...
\begin{definitie}[Peak Signal To Noise Ratio (PSNR)]
  ...
  en
  \[
  S := \| f - \hat f \|_{\ell_2}^2 = \sum_{\boldsymbol j \in \Z^k} (f[\boldsymbol j] - \hat f[\boldsymbol j])^2.
  \]
...
Behalve de illustraties die op de volgende pagina's te zien zijn, hebben we ook een aantal bewegende beelden (3D-signalen) gecomprimeerd. Deze kunt u als lezer vinden door uw webbrowser te sturen naar \url{http://goo.gl/PXTca}.
