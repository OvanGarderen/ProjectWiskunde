...
\includeonly{chap_implementatie, chap_wavelet}
...
Wanneer we kijken naar de grafieken, wordt het direct duidelijk dat de Fouriertransformatie in eigenlijk alle gevallen een slechter resultaat oplevert (zowel in `wolligheid' als gereflecteerd door de PSNR). Het enige geval waarin Fourier echt beter presteert dan de wavelets is wanneer we kijken naar een periodieke functie.
\begin{figure}[h]
  \centering
